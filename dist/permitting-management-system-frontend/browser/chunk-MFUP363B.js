import{a as bt,b as J,c as Et}from"./chunk-N23QNFFO.js";import{a as kt}from"./chunk-JYREPJ6U.js";import{c as ae,d as v,e as j,f as O,g as ht,h as Ct,i as V,l as B,m as L,n as me,o as le,p as se,q as G,s as yt}from"./chunk-HGRQUFQJ.js";import{a as P,b as St}from"./chunk-SJG5BJVG.js";import{a as F,b as Y,c as E,e as I}from"./chunk-FHELIIU2.js";import{Ba as l,Bc as at,Ca as n,Cb as k,Da as i,Db as W,Ea as g,Eb as D,Fc as ne,Gb as Xe,Gc as K,Hc as mt,Ib as De,Ic as lt,L as Ue,M as be,Mb as Ze,Mc as st,Na as A,Nb as et,Nc as dt,O as Ve,Oc as Ie,Pa as h,Pc as pt,R,Ra as p,Rc as ct,S as M,T as Z,Tc as re,U as ye,Ub as q,Uc as oe,Wb as H,Wc as ut,Xb as N,Ya as $e,_ as u,ab as e,bb as y,cb as Be,cd as _t,dc as Le,dd as gt,e as At,eb as ee,fa as $,fb as te,ga as C,gb as ie,ha as m,hb as x,ib as Fe,kb as S,lb as f,mb as We,nd as ft,oa as _,od as vt,pa as b,pc as tt,pd as xt,qa as Ee,qb as Ke,qc as it,rb as Ye,sb as Je,sc as nt,ta as s,ub as Qe,wc as w,xc as rt,yc as ot}from"./chunk-RYSGXS5Z.js";var It=At(kt());var T=class o{constructor(a,t){this.mAppContextService=a;this.http=t}allItems(){let a=`${F.base_url}/detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}createItem(a){let t=`${F.base_url}/detailed-designs-construction-permits`;return this.http.post(t,a)}getOneItem(a){let t=`${F.base_url}/detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}updateItem(a,t){let r=`${F.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}deleteItem(a){let t=`${F.base_url}/detailed-designs-construction-permits/${a.id}`;return this.http.delete(t,this.mAppContextService.getHttpOptions())}paginateItems(a){return this.http.get(a,this.mAppContextService.getHttpOptions())}searchItems(a){let t=`${F.base_url}/search-detailed-designs-construction-permits`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}unpaginatedItems(){let a=`${F.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}getParcelItem(a){let t=`${F.base_url}/parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}getInvestorParcelsItems(a){let t=`${F.base_url}/investor-parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}nextPreviousStatusDetailedPlanItem(a){let t=`${F.base_url}/next-previous-status-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}unpaginatedDetailedPlanItems(){let a=`${F.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}detailedPlanItem(a,t){let r=`${F.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}plannerDetailedPlanItem(a){let t=`${F.base_url}/planner-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a)}professionalRecommendationsDetailedPlanItem(a){let t=`${F.base_url}/professional-recommendations-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}detailedDesignReportRecommendationsDetailedPlanItem(a){let t=`${F.base_url}/detailed-design-report-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}committeeStageDetailedPlanItem(a,t){let r=`${F.base_url}/committee-stage-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}constructionPermitItem(a,t){let r=`${F.base_url}/construction-permit-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}onDownloadProfessionalReport(a){let t=new Ze;t=t.set("Accept","application/pdf");let r=`${F.base_url}/detailed-designs-construction-permits-generate-professional-report-pdf/${a.id}`;return this.http.get(r,{headers:t,responseType:"blob"})}static{this.\u0275fac=function(t){return new(t||o)(Ve(E),Ve(et))}}static{this.\u0275prov=Ue({token:o,factory:o.\u0275fac,providedIn:"root"})}};var qt=o=>({"is-invalid":o}),jt=(o,a,t,r,d,c,ve,Rt,Mt)=>({"bg-secondary text-dark":o,"bg-primary text-dark":a,"bg-dark":t,"bg-warning text-dark":r,"bg-info":d,"bg-danger":c,"bg-light text-dark":ve,"text-muted":Rt,"bg-success":Mt}),Ft=()=>[1],Dt=()=>[2],Ot=(o,a)=>({active:o,disabled:a});function Vt(o,a){o&1&&g(0,"app-progress")}function Bt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Lt(o,a){if(o&1&&(n(0,"div",16),e(1,`
                ...
                `),i()),o&2){let t=p().$implicit;m(2),l("href",x(t.construction_permit_url),C)}}function Gt(o,a){if(o&1&&(n(0,"li")(1,"a",32),Z(),g(2,"svg",33),e(3," Edit"),i()()),o&2){let t=p().$implicit;m(),l("routerLink",Fe("/detailed-designs/edit/",t.id))}}function zt(o,a){if(o&1&&(n(0,"li")(1,"a",32),Z(),g(2,"svg",34),e(3," Process"),i()()),o&2){let t=p().$implicit;m(),l("routerLink",Fe("/detailed-designs/process/",t.id))}}function Ut(o,a){if(o&1){let t=A();n(0,"button",35),h("click",function(){R(t);let d=p().$implicit,c=p(2);return M(c.onDelete(d))}),Z(),g(1,"svg",36),i()}}function $t(o,a){if(o&1&&(n(0,"tr"),e(1,`
                `),n(2,"td"),e(3),i(),e(4,`
                `),n(5,"td"),e(6),i(),e(7,`
                `),n(8,"td"),e(9),i(),e(10,`
                `),n(11,"td"),e(12),i(),e(13,`
                ...
                `),n(34,"td"),e(35,`
                  ...
                  `),i(),e(61,`
                `),i(),e(62,`
              `),i()),o&2){let t=a.$implicit,r=a.index,d=p(2);m(3),Be("",d.mPageFrom+r,"."),m(3),y(t.application_number),m(3),y(t.project_brief),m(3),y(t.investor.name),m(5),y(t.consultant.name),m(4),l("ngClass",Ke(16,jt,[t.detailed_plan_status_id==1,t.detailed_plan_status_id==2,t.detailed_plan_status_id==3,t.detailed_plan_status_id==4,t.detailed_plan_status_id==5,t.detailed_plan_status_id==6,t.detailed_plan_status_id==7,t.detailed_plan_status_id==8,t.detailed_plan_status_id==9])),m(),Be(`
                    `,t.detailed_plan_status==null?null:t.detailed_plan_status.name,`
                  `),m(4),y(Je(27,14,t.created_at)),m(5),l("ngIf",t.construction_permit_url),m(7),l("routerLink",Fe("/detailed-designs/show/",t.id)),m(14),l("ngIf",d.mAppContextService.hasRoles(S(26,Ft))||d.mAppContextService.hasRoles(S(27,Dt))&&(t.status_id==1||t.status_id==2)),m(3),l("ngIf",!d.mAppContextService.hasRoles(S(28,Dt))),m(4),l("ngIf",d.mAppContextService.hasRoles(S(29,Ft)))}}function Wt(o,a){if(o&1&&(n(0,"div",17),e(1,`
          `),n(2,"table",18),e(3,`
            `),n(4,"thead",19),e(5,`
              `),n(6,"tr"),e(7,`
            ...
            `),i(),e(43,`
          `),i(),e(44,`
        `),i()),o&2){let t=p();m(41),l("ngForOf",t.mConstructionPermits)}}function Kt(o,a){if(o&1){let t=A();n(0,"li",39),e(1,`
              `),n(2,"a",40),h("click",function(){let d=R(t).$implicit,c=p(2);return M(c.onChangePage(d.url))}),i(),e(3,`
            `),i()}if(o&2){let t=a.$implicit;l("ngClass",We(2,Ot,t.active,!t.url)),m(2),l("innerHTML",t.label,$)}}function Yt(o,a){if(o&1&&(n(0,"div"),e(1,`
          `),n(2,"ul",37),e(3,`
  ...
  `),n(3,"c-col",2),e(4,`
    `),n(5,"c-card",3),e(6,`
      ...
      `),ye(),n(42,"c-card-body"),e(43,`
        ...
        `),s(48,Jt,4,0,"ng-template",null,0,Qe),e(50,`

      `),i(),e(51,`
    `),i(),e(52,`
  `),i(),e(53,`
`),i()),t&2){let d=$e(49);l("ngIf",r.mProgress()),m(21),l("formGroup",r.itemForm),m(4),l("ngClass",f(7,qt,r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched))),m(10),l("ngIf",r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched)),m(9),l("ngIf",r.mConstructionPermits.length>0)("ngIfElse",d),m(2),l("ngIf",r.links)}},dependencies:[k,W,D,N,P,w,ne,K,mt,re,oe,vt,ft,V,ae,j,O,L,B,tt,Ie,pt,st,dt,Xe],encapsulation:2})}};var U=o=>({"is-invalid":o});function Qt(o,a){o&1&&g(0,"app-progress")}function Xt(o,a){if(o&1&&(n(0,"option",41),e(1),i()),o&2){let t=a.$implicit;l("value",t.id),m(),y(t.application_number)}}function Zt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ei(o,a){if(o&1&&(n(0,"div",42),e(1,`
                              `),s(2,Zt,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("id"))==null||t.errors==null?null:t.errors.required)}}function ti(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ii(o,a){if(o&1&&(n(0,"div",42),e(1,`
                              `),s(2,ti,2,0,"div",0),e(3,`
                              `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("indemnity_form").errors)==null?null:t.required)}}function ni(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ri(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,ni,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("architectural_design").errors)==null?null:t.required)}}function oi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ai(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,oi,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("structural_design").errors)==null?null:t.required)}}function mi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function li(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,mi,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("electrical_design").errors)==null?null:t.required)}}function si(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function di(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,si,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("ict_design").errors)==null?null:t.required)}}function pi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ci(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,pi,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("mechanical_design").errors)==null?null:t.required)}}function ui(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function _i(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,ui,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("landscaping_design").errors)==null?null:t.required)}}function gi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function fi(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,gi,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("signage_design").errors)==null?null:t.required)}}function vi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function xi(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,vi,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("other_necessary_drawings").errors)==null?null:t.required)}}function Si(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function hi(o,a){if(o&1&&(n(0,"div",42),e(1,`
                            `),s(2,Si,2,0,"div",0),e(3,`
                            `),i()),o&2){let t,r=p();m(2),l("ngIf",(t=r.itemForm.get("green_certification_registration").errors)==null?null:t.required)}}function Ci(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function yi(o,a){if(o&1&&(n(0,"div",42),e(1,`
    ...
    `),n(5,"c-card",2),e(6,`
      `),n(7,"c-card-body"),e(8,`
        ...
        `),n(163,"div",3),e(164,`
          `),n(165,"div",4),e(166,`
            `),e(167,`
            `),s(168,sr,4,0,"div",0),e(169,`
            `),e(170,`
            `),s(171,dr,4,0,"div",0),e(172,`
            `),e(173,`
            `),s(174,pr,4,0,"div",0),e(175,`
            `),e(176,`
            `),s(177,cr,4,0,"div",0),e(178,`
            `),e(179,`
            `),s(180,ur,4,0,"div",0),e(181,`
            `),e(182,`
