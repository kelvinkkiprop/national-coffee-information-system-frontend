import{a as J,b as U}from"./chunk-LKYWHRMH.js";import{a as K,c as Q,e as $}from"./chunk-BRAGQGPK.js";import{$a as e,Aa as r,Ba as t,Ca as n,Da as l,Dc as g,Eb as G,Fc as v,Gc as E,Ib as f,L as k,M as u,Nb as N,O as M,Sc as V,T as s,Tc as C,U as L,Uc as y,Vc as W,Xb as z,_ as j,dc as A,fd as B,gb as d,ha as m,jb as x,na as D,oa as F,pa as S,pc as R,qd as O,rc as H,rd as b,sa as p,sd as h,td as q}from"./chunk-AJQSUAPJ.js";var I=class o{constructor(i,a){this.mAppContextService=i;this.http=a}allItems(){let i=`${K.base_url}/dashboard`;return this.http.get(i,this.mAppContextService.getHttpOptions())}static{this.\u0275fac=function(a){return new(a||o)(M(Q),M(N))}}static{this.\u0275prov=k({token:o,factory:o.\u0275fac,providedIn:"root"})}};var P=()=>({gx:3,gy:3});function Z(o,i){o&1&&l(0,"app-progress")}function ee(o,i){o&1&&(e(0,`
            `),s(),l(1,"svg",27),e(2,`
