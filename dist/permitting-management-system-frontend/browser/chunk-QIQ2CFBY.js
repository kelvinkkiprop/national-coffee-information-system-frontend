import{a as Et,b as se,c as Ft}from"./chunk-N23QNFFO.js";import{a as At}from"./chunk-JYREPJ6U.js";import{c as oe,d as g,e as j,f as V,g as St,h as Ct,i as L,l as H,m as G,n as ae,o as le,p as me,q as U,s as bt}from"./chunk-HGRQUFQJ.js";import{a as T,b as ht}from"./chunk-SJG5BJVG.js";import{a as R,b as re,c as F,e as D}from"./chunk-FHELIIU2.js";import{Ba as l,Bc as lt,Ca as n,Cb as B,Da as i,Db as W,Ea as y,Eb as P,Fc as te,Gb as Ze,Gc as K,Hc as mt,Ib as De,Ic as st,L as $e,M as Fe,Mb as et,Mc as dt,Na as k,Nb as tt,Nc as ct,O as Ve,Oc as Te,Pa as h,Pc as pt,R as N,Ra as _,Rc as _t,S as q,T as xe,Tc as ie,U as Ee,Ub as O,Uc as ne,Wb as z,Wc as ut,Xb as M,Ya as We,_ as f,ab as e,bb as S,cb as Le,cd as gt,dc as He,dd as vt,e as Mt,eb as Q,fa as $,fb as X,ga as b,gb as Z,ha as m,hb as x,ib as Pe,kb as C,lb as u,mb as Ke,nd as ft,oa as v,od as xt,pa as I,pc as it,pd as yt,qa as Ie,qb as Ye,qc as nt,rb as Je,sb as Qe,sc as rt,ta as d,ub as Xe,wc as A,xc as ot,yc as at}from"./chunk-RYSGXS5Z.js";var Dt=Mt(At());var w=class o{constructor(a,t){this.mAppContextService=a;this.http=t}allItems(){let a=`${R.base_url}/detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}createItem(a){let t=`${R.base_url}/detailed-designs-construction-permits`;return this.http.post(t,a)}getOneItem(a){let t=`${R.base_url}/detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}updateItem(a,t){let r=`${R.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}deleteItem(a){let t=`${R.base_url}/detailed-designs-construction-permits/${a.id}`;return this.http.delete(t,this.mAppContextService.getHttpOptions())}paginateItems(a){return this.http.get(a,this.mAppContextService.getHttpOptions())}searchItems(a){let t=`${R.base_url}/search-detailed-designs-construction-permits`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}unpaginatedItems(){let a=`${R.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}getParcelItem(a){let t=`${R.base_url}/parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}getInvestorParcelsItems(a){let t=`${R.base_url}/investor-parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}nextPreviousStatusDetailedPlanItem(a){let t=`${R.base_url}/next-previous-status-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}unpaginatedDetailedPlanItems(){let a=`${R.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}detailedPlanItem(a,t){let r=`${R.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}plannerDetailedPlanItem(a){let t=`${R.base_url}/planner-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a)}professionalRecommendationsDetailedPlanItem(a){let t=`${R.base_url}/professional-recommendations-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}detailedDesignReportRecommendationsDetailedPlanItem(a){let t=`${R.base_url}/detailed-design-report-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}committeeStageDetailedPlanItem(a,t){let r=`${R.base_url}/committee-stage-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}constructionPermitItem(a,t){let r=`${R.base_url}/construction-permit-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}onDownloadProfessionalReport(a){let t=new et;t=t.set("Accept","application/pdf");let r=`${R.base_url}/detailed-designs-construction-permits-generate-professional-report-pdf/${a.id}`;return this.http.get(r,{headers:t,responseType:"blob"})}static{this.\u0275fac=function(t){return new(t||o)(Ve(F),Ve(tt))}}static{this.\u0275prov=$e({token:o,factory:o.\u0275fac,providedIn:"root"})}};var kt=o=>({"is-invalid":o}),Bt=(o,a,t,r,c,p,s,Nt,qt)=>({"bg-secondary text-dark":o,"bg-primary text-dark":a,"bg-dark":t,"bg-warning text-dark":r,"bg-info":c,"bg-danger":p,"bg-light text-dark":s,"text-muted":Nt,"bg-success":qt}),It=()=>[1],Pt=()=>[2],Ot=(o,a)=>({active:o,disabled:a});function jt(o,a){o&1&&y(0,"app-progress")}function Vt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Lt(o,a){if(o&1&&(n(0,"div",16),e(1,`
  ...
  `),n(3,"c-col",2),e(4,`
    ...
    `),i(),e(52,`
  `),i(),e(53,`
`),i()),t&2){let c=We(49);l("ngIf",r.mProgress()),m(21),l("formGroup",r.itemForm),m(4),l("ngClass",u(7,kt,r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched))),m(10),l("ngIf",r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched)),m(9),l("ngIf",r.mConstructionPermits.length>0)("ngIfElse",c),m(2),l("ngIf",r.links)}},dependencies:[B,W,P,M,T,A,te,K,mt,ie,ne,xt,ft,L,oe,j,V,G,H,it,Te,pt,dt,ct,Ze],encapsulation:2})}};var J=o=>({"is-invalid":o});function Qt(o,a){o&1&&y(0,"app-progress")}function Xt(o,a){if(o&1&&(n(0,"option",41),e(1),i()),o&2){let t=a.$implicit;l("value",t.id),m(),S(t.application_number)}}function Zt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ei(o,a){if(o&1&&(n(0,"div",42),e(1,`
