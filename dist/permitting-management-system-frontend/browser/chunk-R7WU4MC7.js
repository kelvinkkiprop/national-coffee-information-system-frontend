import{a as ee,b as te}from"./chunk-LKYWHRMH.js";import{a as h,c as Y,e as Z}from"./chunk-BRAGQGPK.js";import{$a as e,Aa as c,Ba as t,Ca as n,Da as x,Db as $,Eb as G,Fc as U,Gc as q,Hc as z,Ib as w,Ic as J,L as N,M as f,Ma as E,Nb as P,O as F,Oa as b,Qa as p,R as v,S as u,T as _,Tc as K,U as S,Uc as Q,Wb as H,Wc as W,Xa as O,_ as j,ab as I,dc as V,ha as d,na as g,oa as R,pa as C,pc as A,pd as X,qc as B,sa as a,sc as L,tb as y}from"./chunk-AJQSUAPJ.js";var D=class i{constructor(m,o){this.mAppContextService=m;this.http=o}allItems(){let m=`${h.base_url}/downloads`;return this.http.get(m,this.mAppContextService.getHttpOptions())}static{this.\u0275fac=function(o){return new(o||i)(F(Y),F(P))}}static{this.\u0275prov=N({token:i,factory:i.\u0275fac,providedIn:"root"})}};function oe(i,m){i&1&&x(0,"app-progress")}function me(i,m){if(i&1){let o=E();t(0,"div",9),e(1,`
                `),t(2,"div",10),e(3,`
                  `),t(4,"div",11),e(5,`
