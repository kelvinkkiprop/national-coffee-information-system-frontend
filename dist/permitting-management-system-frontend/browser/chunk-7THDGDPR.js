import{a as J,b as U}from"./chunk-OCIEZIGI.js";import{a as K,b as Q,d as $}from"./chunk-EAW54KGY.js";import{Aa as n,Ac as g,Ba as l,Bb as G,Cc as v,Dc as E,Fb as f,I as k,J as u,Kb as N,L as M,Pc as V,Q as s,Qc as C,R as L,Rc as y,Sc as W,Ub as z,X as j,Za as e,ac as A,cd as B,ea as m,eb as d,hb as x,la as D,ma as F,mc as R,na as S,nd as O,oc as H,od as b,pd as h,qa as p,qd as q,ya as r,za as t}from"./chunk-THDKPFAR.js";var I=class o{constructor(i,a){this.mAppContextService=i;this.http=a}allItems(){let i=`${K.base_url}/dashboard`;return this.http.get(i,this.mAppContextService.getHttpOptions())}static{this.\u0275fac=function(a){return new(a||o)(M(Q),M(N))}}static{this.\u0275prov=k({token:o,factory:o.\u0275fac,providedIn:"root"})}};var P=()=>({gx:3,gy:3});function Z(o,i){o&1&&l(0,"app-progress")}function ee(o,i){o&1&&(e(0,`
            `),s(),l(1,"svg",27),e(2,`
