import{a as U,b as X}from"./chunk-SJG5BJVG.js";import{a as $,c as I,e as J}from"./chunk-FHELIIU2.js";import{Ba as a,Ca as t,Da as n,Dc as v,Ea as l,Eb as R,Fc as C,Gc as E,Ib as g,L,M as u,Nb as z,O as D,Ra as N,Sc as B,T as c,Tc as y,U as j,Uc as b,Vc as O,Xb as H,_ as F,ab as e,dc as T,fd as q,ha as m,hb as d,kb as p,oa as S,pa as G,pc as V,qa as f,qd as K,rc as W,rd as h,sd as _,ta as s,td as Q}from"./chunk-RYSGXS5Z.js";var w=class i{constructor(o,r){this.mAppContextService=o;this.http=r}allItems(){let o=`${$.base_url}/dashboard`;return this.http.get(o,this.mAppContextService.getHttpOptions())}static{this.\u0275fac=function(r){return new(r||i)(D(I),D(z))}}static{this.\u0275prov=L({token:i,factory:i.\u0275fac,providedIn:"root"})}};var P=()=>({gx:3,gy:3}),te=()=>[2];function ne(i,o){i&1&&l(0,"app-progress")}function ie(i,o){i&1&&(e(0,`
            `),c(),l(1,"svg",27),e(2,`
...
`),n()),r&2&&(a("ngIf",x.mProgress()),m(5),a("gutter",p(12,P)),m(18),a("gutter",p(13,P)),m(120),a("gutter",p(14,P)),m(9),a("ngIf",!x.mAppContextService.hasRoles(p(15,te))),m(2),a("gutter",p(16,P)),m(10),a("value",d(x.myConstructionPermits))("title","Construction Permits"),m(8),a("value",d(x.myComplianceAndEnforcements))("title","Compliance & Enforcements"))},dependencies:[R,H,U,y,O,b,C,E,v,h,W,V,_],encapsulation:2})}};var le=[{path:"",redirectTo:"index",pathMatch:"full"},{path:"index",component:A,data:{title:"Home"}}],M=class i{static{this.\u0275fac=function(r){return new(r||i)}}static{this.\u0275mod=f({type:i})}static{this.\u0275inj=u({imports:[g,T.forChild(le),T]})}};var Y=class i{static{this.\u0275fac=function(r){return new(r||i)}}static{this.\u0275mod=f({type:i})}static{this.\u0275inj=u({imports:[g,M,X,y,B,b,C,E,v,q,K,h,Q,_]})}};export{Y as DashboardModule};
