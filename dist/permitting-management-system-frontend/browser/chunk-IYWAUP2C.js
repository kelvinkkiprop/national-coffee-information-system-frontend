import{a as Et,b as te,c as Ft}from"./chunk-N23QNFFO.js";import{a as qt}from"./chunk-JYREPJ6U.js";import{c as ee,d as f,e as k,f as j,g as yt,h as Ct,i as O,l as B,m as V,n as ge,o as ue,p as fe,q as G,s as bt}from"./chunk-HGRQUFQJ.js";import{a as I,b as St}from"./chunk-SJG5BJVG.js";import{a as T,b as Z,c as b,e as D}from"./chunk-FHELIIU2.js";import{Ba as l,Bc as mt,Ca as n,Cb as A,Da as i,Db as Y,Ea as v,Eb as F,Fc as J,Gb as Ze,Gc as z,Hc as lt,Ib as Ie,Ic as st,L as We,M as Ee,Mb as et,Mc as dt,Na as L,Nb as tt,Nc as pt,O as Ve,Oc as Pe,Pa as x,Pc as ct,R as w,Ra as c,Rc as _t,S as M,T as _e,Tc as Q,U as be,Ub as q,Uc as X,Wb as H,Wc as gt,Xb as N,Ya as $e,_ as g,ab as e,bb as C,cb as Le,cd as ut,dc as He,dd as ft,e as At,eb as ne,fa as $,fb as re,ga as y,gb as oe,ha as m,hb as h,ib as De,kb as S,lb as u,mb as Ke,nd as vt,oa as _,od as xt,pa as E,pc as it,pd as ht,qa as Fe,qb as Ye,qc as nt,rb as Je,sb as Qe,sc as rt,ta as s,ub as Xe,wc as R,xc as ot,yc as at}from"./chunk-RYSGXS5Z.js";var Pt=At(qt());var P=class o{constructor(a,t){this.mAppContextService=a;this.http=t}allItems(){let a=`${T.base_url}/detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}createItem(a){let t=`${T.base_url}/detailed-designs-construction-permits`;return this.http.post(t,a)}getOneItem(a){let t=`${T.base_url}/detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}updateItem(a,t){let r=`${T.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}deleteItem(a){let t=`${T.base_url}/detailed-designs-construction-permits/${a.id}`;return this.http.delete(t,this.mAppContextService.getHttpOptions())}paginateItems(a){return this.http.get(a,this.mAppContextService.getHttpOptions())}searchItems(a){let t=`${T.base_url}/search-detailed-designs-construction-permits`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}unpaginatedItems(){let a=`${T.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}getParcelItem(a){let t=`${T.base_url}/parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}getInvestorParcelsItems(a){let t=`${T.base_url}/investor-parcels-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}nextPreviousStatusDetailedPlanItem(a){let t=`${T.base_url}/next-previous-status-detailed-designs-construction-permits/${a}`;return this.http.get(t,this.mAppContextService.getHttpOptions())}unpaginatedDetailedPlanItems(){let a=`${T.base_url}/unpaginated-items-detailed-designs-construction-permits`;return this.http.get(a,this.mAppContextService.getHttpOptions())}detailedPlanItem(a,t){let r=`${T.base_url}/detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}plannerDetailedPlanItem(a){let t=`${T.base_url}/planner-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a)}professionalRecommendationsDetailedPlanItem(a){let t=`${T.base_url}/professional-recommendations-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}detailedDesignReportRecommendationsDetailedPlanItem(a){let t=`${T.base_url}/detailed-design-report-detailed-designs-construction-permits/${a.id}`;return this.http.post(t,a,this.mAppContextService.getHttpOptions())}committeeStageDetailedPlanItem(a,t){let r=`${T.base_url}/committee-stage-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}constructionPermitItem(a,t){let r=`${T.base_url}/construction-permit-detailed-designs-construction-permits/${a}`;return this.http.post(r,t)}onDownloadProfessionalReport(a){let t=new et;t=t.set("Accept","application/pdf");let r=`${T.base_url}/detailed-designs-construction-permits-generate-professional-report-pdf/${a.id}`;return this.http.get(r,{headers:t,responseType:"blob"})}static{this.\u0275fac=function(t){return new(t||o)(Ve(b),Ve(tt))}}static{this.\u0275prov=We({token:o,factory:o.\u0275fac,providedIn:"root"})}};var kt=o=>({"is-invalid":o}),jt=(o,a,t,r,d,p,xe,wt,Mt)=>({"bg-secondary text-dark":o,"bg-primary text-dark":a,"bg-dark":t,"bg-warning text-dark":r,"bg-info":d,"bg-danger":p,"bg-light text-dark":xe,"text-muted":wt,"bg-success":Mt}),Dt=()=>[1],It=()=>[2],Ot=(o,a)=>({active:o,disabled:a});function Bt(o,a){o&1&&v(0,"app-progress")}function Vt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Lt(o,a){if(o&1&&(n(0,"div",16),e(1,`
                ...
                `),i()),o&2){let t=c().$implicit;m(2),l("href",h(t.construction_permit_url),y)}}function Gt(o,a){if(o&1&&(n(0,"li")(1,"a",32),_e(),v(2,"svg",33),e(3," Edit"),i()()),o&2){let t=c().$implicit;m(),l("routerLink",De("/detailed-designs/edit/",t.id))}}function zt(o,a){if(o&1&&(n(0,"li")(1,"a",32),_e(),v(2,"svg",34),e(3," Process"),i()()),o&2){let t=c().$implicit;m(),l("routerLink",De("/detailed-designs/process/",t.id))}}function Ut(o,a){if(o&1){let t=L();n(0,"button",35),x("click",function(){w(t);let d=c().$implicit,p=c(2);return M(p.onDelete(d))}),_e(),v(1,"svg",36),i()}}function Wt(o,a){if(o&1&&(n(0,"tr"),e(1,`
                `),n(2,"td"),e(3),i(),e(4,`
                `),n(5,"td"),e(6),i(),e(7,`
                `),n(8,"td"),e(9),i(),e(10,`
                `),n(11,"td"),e(12),i(),e(13,`
                ...
                `),n(34,"td"),e(35,`
                  `),n(36,"div",23),e(37,`
                    `),n(38,"a",24),_e(),v(39,"svg",25),i(),e(40,`
                    `),e(41,`
        ...
        `),i()),o&2){let t=c();m(41),l("ngForOf",t.mConstructionPermits)}}function Kt(o,a){if(o&1){let t=L();n(0,"li",39),e(1,`
              `),n(2,"a",40),x("click",function(){let d=w(t).$implicit,p=c(2);return M(p.onChangePage(d.url))}),i(),e(3,`
  ...
  `),n(3,"c-col",2),e(4,`
    ...
    `),i(),e(52,`
  `),i(),e(53,`
`),i()),t&2){let d=$e(49);l("ngIf",r.mProgress()),m(21),l("formGroup",r.itemForm),m(4),l("ngClass",u(7,kt,r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched))),m(10),l("ngIf",r.search_term.invalid&&(r.search_term.dirty||r.search_term.touched)),m(9),l("ngIf",r.mConstructionPermits.length>0)("ngIfElse",d),m(2),l("ngIf",r.links)}},dependencies:[A,Y,F,N,I,R,J,z,lt,Q,X,xt,vt,O,ee,k,j,V,B,it,Pe,ct,dt,pt,Ze],encapsulation:2})}};var W=o=>({"is-invalid":o});function Qt(o,a){o&1&&v(0,"app-progress")}function Xt(o,a){if(o&1&&(n(0,"option",41),e(1),i()),o&2){let t=a.$implicit;l("value",t.id),m(),C(t.application_number)}}function Zt(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function ei(o,a){if(o&1&&(n(0,"div",42),e(1,`
  ...
  `),n(3,"c-col",1),e(4,`
    `),n(5,"c-card",2),e(6,`
      `),n(7,"c-card-body"),e(8,`
        ...
        `),i(),e(197,`
    `),i(),e(198,`
`),i()),t&2){let d,p;l("ngIf",r.mProgress()),m(11),l("formGroup",r.itemForm),m(17),l("ngClass",u(28,W,((d=r.itemForm.get("id"))==null?null:d.invalid)&&(((d=r.itemForm.get("id"))==null?null:d.dirty)||((d=r.itemForm.get("id"))==null?null:d.touched)))),m(5),l("ngForOf",r.mMasterplanSubmissions),m(3),l("ngIf",((p=r.itemForm.get("id"))==null?null:p.invalid)&&(((p=r.itemForm.get("id"))==null?null:p.dirty)||((p=r.itemForm.get("id"))==null?null:p.touched))),m(11),l("ngClass",u(30,W,r.itemForm.get("indemnity_form").invalid&&(r.itemForm.get("indemnity_form").dirty||r.itemForm.get("indemnity_form").touched))),m(2),l("ngIf",r.itemForm.get("indemnity_form").invalid&&(r.itemForm.get("indemnity_form").dirty||r.itemForm.get("indemnity_form").touched)),m(11),l("ngClass",u(32,W,r.itemForm.get("architectural_design").invalid&&(r.itemForm.get("architectural_design").dirty||r.itemForm.get("architectural_design").touched))),m(2),l("ngIf",r.itemForm.get("architectural_design").invalid&&(r.itemForm.get("architectural_design").dirty||r.itemForm.get("architectural_design").touched)),m(11),l("ngClass",u(34,W,r.itemForm.get("structural_design").invalid&&(r.itemForm.get("structural_design").dirty||r.itemForm.get("structural_design").touched))),m(2),l("ngIf",r.itemForm.get("structural_design").invalid&&(r.itemForm.get("structural_design").dirty||r.itemForm.get("structural_design").touched)),m(11),l("ngClass",u(36,W,r.itemForm.get("electrical_design").invalid&&(r.itemForm.get("electrical_design").dirty||r.itemForm.get("electrical_design").touched))),m(2),l("ngIf",r.itemForm.get("electrical_design").invalid&&(r.itemForm.get("electrical_design").dirty||r.itemForm.get("electrical_design").touched)),m(11),l("ngClass",u(38,W,r.itemForm.get("ict_design").invalid&&(r.itemForm.get("ict_design").dirty||r.itemForm.get("ict_design").touched))),m(2),l("ngIf",r.itemForm.get("ict_design").invalid&&(r.itemForm.get("ict_design").dirty||r.itemForm.get("ict_design").touched)),m(11),l("ngClass",u(40,W,r.itemForm.get("mechanical_design").invalid&&(r.itemForm.get("mechanical_design").dirty||r.itemForm.get("mechanical_design").touched))),m(2),l("ngIf",r.itemForm.get("mechanical_design").invalid&&(r.itemForm.get("mechanical_design").dirty||r.itemForm.get("mechanical_design").touched)),m(11),l("ngClass",u(42,W,r.itemForm.get("landscaping_design").invalid&&(r.itemForm.get("landscaping_design").dirty||r.itemForm.get("landscaping_design").touched))),m(2),l("ngIf",r.itemForm.get("landscaping_design").invalid&&(r.itemForm.get("landscaping_design").dirty||r.itemForm.get("landscaping_design").touched)),m(11),l("ngClass",u(44,W,r.itemForm.get("signage_design").invalid&&(r.itemForm.get("signage_design").dirty||r.itemForm.get("signage_design").touched))),m(2),l("ngIf",r.itemForm.get("signage_design").invalid&&(r.itemForm.get("signage_design").dirty||r.itemForm.get("signage_design").touched)),m(11),l("ngClass",u(46,W,r.itemForm.get("other_relevant_documents").invalid&&(r.itemForm.get("other_relevant_documents").dirty||r.itemForm.get("other_relevant_documents").touched))),m(2),l("ngIf",r.itemForm.get("other_relevant_documents").invalid&&(r.itemForm.get("other_relevant_documents").dirty||r.itemForm.get("other_relevant_documents").touched)),m(11),l("ngClass",u(48,W,r.itemForm.get("green_certification_registration").invalid&&(r.itemForm.get("green_certification_registration").dirty||r.itemForm.get("green_certification_registration").touched))),m(2),l("ngIf",r.itemForm.get("green_certification_registration").invalid&&(r.itemForm.get("green_certification_registration").dirty||r.itemForm.get("green_certification_registration").touched)),m(11),l("ngClass",u(50,W,r.itemForm.get("nema_project_report").invalid&&(r.itemForm.get("nema_project_report").dirty||r.itemForm.get("nema_project_report").touched))),m(2),l("ngIf",r.itemForm.get("nema_project_report").invalid&&(r.itemForm.get("nema_project_report").dirty||r.itemForm.get("nema_project_report").touched)),m(11),l("disabled",r.itemForm.invalid)}},dependencies:[A,Y,F,N,I,R,J,z,Q,X,O,ue,fe,ee,ge,k,j,V,B],encapsulation:2})}};var K=o=>({"is-invalid":o});function Ei(o,a){o&1&&v(0,"app-progress")}function Fi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Di(o,a){if(o&1&&(n(0,"div",37),e(1,`
                            ...
                            `),i()),o&2){let t,r=c();m(2),l("ngIf",(t=r.itemForm.get("electrical_design").errors)==null?null:t.required)}}function Mi(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Ai(o,a){if(o&1&&(n(0,"div",37),e(1,`
                            `),s(2,Mi,2,0,"div",0),e(3,`
  ...
  `),n(3,"c-col",1),e(4,`
    `),n(5,"c-card",2),e(6,`
      `),n(7,"c-card-body"),e(8,`
        ...
        `),i(),e(178,`
    `),i(),e(179,`
`),i()),t&2&&(l("ngIf",r.mProgress()),m(11),l("formGroup",r.itemForm),m(17),l("ngClass",u(25,K,r.itemForm.get("indemnity_form").invalid&&(r.itemForm.get("indemnity_form").dirty||r.itemForm.get("indemnity_form").touched))),m(2),l("ngIf",r.itemForm.get("indemnity_form").invalid&&(r.itemForm.get("indemnity_form").dirty||r.itemForm.get("indemnity_form").touched)),m(11),l("ngClass",u(27,K,r.itemForm.get("architectural_design").invalid&&(r.itemForm.get("architectural_design").dirty||r.itemForm.get("architectural_design").touched))),m(2),l("ngIf",r.itemForm.get("architectural_design").invalid&&(r.itemForm.get("architectural_design").dirty||r.itemForm.get("architectural_design").touched)),m(11),l("ngClass",u(29,K,r.itemForm.get("structural_design").invalid&&(r.itemForm.get("structural_design").dirty||r.itemForm.get("structural_design").touched))),m(2),l("ngIf",r.itemForm.get("structural_design").invalid&&(r.itemForm.get("structural_design").dirty||r.itemForm.get("structural_design").touched)),m(11),l("ngClass",u(31,K,r.itemForm.get("electrical_design").invalid&&(r.itemForm.get("electrical_design").dirty||r.itemForm.get("electrical_design").touched))),m(2),l("ngIf",r.itemForm.get("electrical_design").invalid&&(r.itemForm.get("electrical_design").dirty||r.itemForm.get("electrical_design").touched)),m(11),l("ngClass",u(33,K,r.itemForm.get("ict_design").invalid&&(r.itemForm.get("ict_design").dirty||r.itemForm.get("ict_design").touched))),m(2),l("ngIf",r.itemForm.get("ict_design").invalid&&(r.itemForm.get("ict_design").dirty||r.itemForm.get("ict_design").touched)),m(11),l("ngClass",u(35,K,r.itemForm.get("mechanical_design").invalid&&(r.itemForm.get("mechanical_design").dirty||r.itemForm.get("mechanical_design").touched))),m(2),l("ngIf",r.itemForm.get("mechanical_design").invalid&&(r.itemForm.get("mechanical_design").dirty||r.itemForm.get("mechanical_design").touched)),m(11),l("ngClass",u(37,K,r.itemForm.get("landscaping_design").invalid&&(r.itemForm.get("landscaping_design").dirty||r.itemForm.get("landscaping_design").touched))),m(2),l("ngIf",r.itemForm.get("landscaping_design").invalid&&(r.itemForm.get("landscaping_design").dirty||r.itemForm.get("landscaping_design").touched)),m(11),l("ngClass",u(39,K,r.itemForm.get("signage_design").invalid&&(r.itemForm.get("signage_design").dirty||r.itemForm.get("signage_design").touched))),m(2),l("ngIf",r.itemForm.get("signage_design").invalid&&(r.itemForm.get("signage_design").dirty||r.itemForm.get("signage_design").touched)),m(11),l("ngClass",u(41,K,r.itemForm.get("other_relevant_documents").invalid&&(r.itemForm.get("other_relevant_documents").dirty||r.itemForm.get("other_relevant_documents").touched))),m(2),l("ngIf",r.itemForm.get("other_relevant_documents").invalid&&(r.itemForm.get("other_relevant_documents").dirty||r.itemForm.get("other_relevant_documents").touched)),m(11),l("ngClass",u(43,K,r.itemForm.get("green_certification_registration").invalid&&(r.itemForm.get("green_certification_registration").dirty||r.itemForm.get("green_certification_registration").touched))),m(2),l("ngIf",r.itemForm.get("green_certification_registration").invalid&&(r.itemForm.get("green_certification_registration").dirty||r.itemForm.get("green_certification_registration").touched)),m(11),l("ngClass",u(45,K,r.itemForm.get("nema_project_report").invalid&&(r.itemForm.get("nema_project_report").dirty||r.itemForm.get("nema_project_report").touched))),m(2),l("ngIf",r.itemForm.get("nema_project_report").invalid&&(r.itemForm.get("nema_project_report").dirty||r.itemForm.get("nema_project_report").touched)),m(11),l("disabled",r.itemForm.invalid))},dependencies:[A,F,N,I,R,J,z,Q,X,O,ee,k,j,V,B],encapsulation:2})}};var $i=()=>[2];function Ki(o,a){o&1&&v(0,"app-progress")}function Yi(o,a){if(o&1&&(n(0,"div",11),e(1),i()),o&2){let t=c();m(),C(t.item.investor==null?null:t.item.investor.name)}}function Ji(o,a){if(o&1&&(n(0,"div",11),e(1),i()),o&2){let t=c();m(),C(t.item.type==null?null:t.item.type.name)}}function Qi(o,a){if(o&1&&(n(0,"div"),e(1,`
  ...
  `),n(3,"c-col",1),e(4,`
      ...
      `),n(7,"c-card-body"),e(8,`
        ...
        `),n(9,"div"),e(10,`
          ...
          `),n(55,"fieldset",3),e(56,`
            ...
            `),i(),e(184,`
          `),i(),e(185,`
          `),s(186,sn,130,8,"fieldset",14),e(187,`
    ...
    `),i(),e(197,`
  `),i(),e(198,`
`),i()),t&2&&(l("ngIf",r.mProgress()),m(26),l("ngIf",r.item.investor),m(11),l("ngIf",r.item.type),m(12),C(r.item.project_brief),m(21),l("ngIf",r.item.indemnity_form),m(11),l("ngIf",r.item.architectural_design),m(11),l("ngIf",r.item.structural_design),m(11),l("ngIf",r.item.electrical_design),m(11),l("ngIf",r.item.ict_design),m(11),l("ngIf",r.item.mechanical_design),m(11),l("ngIf",r.item.landscaping_design),m(11),l("ngIf",r.item.signage_design),m(11),l("ngIf",r.item.other_relevant_documents),m(11),l("ngIf",r.item.green_certification_registration),m(11),l("ngIf",r.item.nema_project_report),m(6),l("ngIf",!r.mAppContextService.hasRoles(S(16,$i))))},dependencies:[F,N,I,R,J,z,Q,X],encapsulation:2})}};var Tt=o=>({"is-invalid":o});function dn(o,a){o&1&&v(0,"app-progress")}function pn(o,a){if(o&1&&(n(0,"option",15),e(1),i()),o&2){let t=a.$implicit;l("value",h(t.id)),m(),C(t.alias)}}function cn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function _n(o,a){if(o&1&&(n(0,"div",16),s(1,cn,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("detailed_plan_status_id"))==null||t.errors==null?null:t.errors.required)}}function gn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function un(o,a){if(o&1&&(n(0,"div",16),s(1,gn,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("remarks").errors)==null?null:t.required)}}var we=class o{constructor(a,t,r,d,p,xe){this.mToastrService=a;this.mDetailedDesignService=t;this.mAppContextService=r;this.router=d;this.fb=p;this.route=xe;this.mProgress=g(!1);this.item={};this.mEditor=Z;this.itemForm=this.fb.group({detailed_plan_status_id:["",f.required],remarks:["",f.nullValidator]})}ngOnInit(){this.getItem()}getItem(){this.id=this.route.snapshot.paramMap.get("id"),this.mProgress=g(!0),this.mDetailedDesignService.getOneItem(this.id).subscribe({next:a=>{a&&(this.item=a,this.getNextPreviousDetailedPlanStatus(),this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onSubmit(a){let t={id:this.id,detailed_plan_status_id:a.detailed_plan_status_id,remarks:a.remarks};this.mProgress=g(!0),this.mDetailedDesignService.plannerDetailedPlanItem(t).subscribe({next:r=>{this.mToastrService.success(r.message),this.router.navigateByUrl("/detailed-designs"),this.mProgress=g(!1)},error:r=>{r.error.message&&this.mToastrService.error(r.error.message),this.mProgress=g(!1)}})}getNextPreviousDetailedPlanStatus(){this.mProgress=g(!0),this.mDetailedDesignService.nextPreviousStatusDetailedPlanItem(this.item.detailed_plan_status_id).subscribe({next:a=>{a&&(this.mNextPreviousStatuses=a,this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}static{this.\u0275fac=function(t){return new(t||o)(_(D),_(P),_(b),_(H),_(G),_(q))}}static{this.\u0275cmp=E({type:o,selectors:[["app-planner-review"]],standalone:!1,decls:24,vars:14,consts:[[4,"ngIf"],[3,"ngSubmit","formGroup"],[1,"row"],[1,"col-md-12"],[1,"form-group","mb-3"],["for","detailed_plan_status_id",1,"col-form-label","required"],["formControlName","detailed_plan_status_id","type","text",1,"form-control",3,"ngClass"],["value","","disabled","true","selected","true"],[3,"value",4,"ngFor","ngForOf"],["class","invalid-feedback","role","alert",4,"ngIf"],["for","remarks",1,"col-form-label","required1"],["formControlName","remarks","type","text",1,"form-control1",3,"editor","config","ngClass"],[1,"mt-3","text-right"],["routerLink","/detailed-designs","cButton","","color","danger",1,"me-2"],["type","submit","cButton","","color","success",3,"disabled"],[3,"value"],["role","alert",1,"invalid-feedback"]],template:function(t,r){if(t&1&&(s(0,dn,1,0,"app-progress",0),n(1,"div")(2,"form",1),x("ngSubmit",function(){return r.onSubmit(r.itemForm.value)}),n(3,"div",2)(4,"div",3)(5,"div",4)(6,"label",5),e(7,"Status:"),i(),n(8,"select",6)(9,"option",7),e(10,"--- Select status ---"),i(),s(11,pn,2,3,"option",8),i(),s(12,_n,2,1,"div",9),i()(),n(13,"div",3)(14,"div",4)(15,"label",10),e(16,"Additional Remarks:"),i(),v(17,"ckeditor",11),s(18,un,2,1,"div",9),i()()(),n(19,"div",12)(20,"button",13),e(21,"Cancel"),i(),n(22,"button",14),e(23,"Submit"),i()()()()),t&2){let d,p;l("ngIf",r.mProgress()),m(2),l("formGroup",r.itemForm),m(6),l("ngClass",u(10,Tt,((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.invalid)&&(((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.dirty)||((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.touched)))),m(3),l("ngForOf",r.mNextPreviousStatuses),m(),l("ngIf",((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.invalid)&&(((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.dirty)||((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.touched))),m(5),l("editor",r.mEditor)("config",r.mAppContextService.ckEditorConfig)("ngClass",u(12,Tt,r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched))),m(),l("ngIf",r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched)),m(4),l("disabled",r.itemForm.invalid)}},dependencies:[A,Y,F,N,I,R,O,ue,fe,ge,k,j,V,B,te],encapsulation:2})}};var ye=()=>[1],vn=()=>[12],xn=()=>[13],hn=()=>[14],Sn=()=>[9],yn=()=>[15],Cn=()=>[16],ve=o=>({"is-invalid":o});function bn(o,a){o&1&&v(0,"app-progress")}function En(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Fn(o,a){if(o&1&&(n(0,"div",11),s(1,En,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("architect_report").errors)==null?null:t.required)}}function Dn(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",8),e(5,"Architect Report:"),i(),n(6,"ckeditor",9),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.architect_report,d)||(p.item.architect_report=d),M(d)}),i(),s(7,Fn,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.architect_report),l("ngClass",u(5,ve,t.itemForm.get("architect_report").invalid&&(t.itemForm.get("architect_report").dirty||t.itemForm.get("architect_report").touched))),m(),l("ngIf",t.itemForm.get("architect_report").invalid&&(t.itemForm.get("architect_report").dirty||t.itemForm.get("architect_report").touched))}}function In(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Pn(o,a){if(o&1&&(n(0,"div",11),s(1,In,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("structural_engineer_report").errors)==null?null:t.required)}}function Tn(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",12),e(5,"Structural Engineer Report:"),i(),n(6,"ckeditor",13),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.structural_engineer_report,d)||(p.item.structural_engineer_report=d),M(d)}),i(),s(7,Pn,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.structural_engineer_report),l("ngClass",u(5,ve,t.itemForm.get("structural_engineer_report").invalid&&(t.itemForm.get("structural_engineer_report").dirty||t.itemForm.get("structural_engineer_report").touched))),m(),l("ngIf",t.itemForm.get("structural_engineer_report").invalid&&(t.itemForm.get("structural_engineer_report").dirty||t.itemForm.get("structural_engineer_report").touched))}}function Nn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Rn(o,a){if(o&1&&(n(0,"div",11),s(1,Nn,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("electrical_engineer_report").errors)==null?null:t.required)}}function wn(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",14),e(5,"Electrical Engineer Report:"),i(),n(6,"ckeditor",15),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.electrical_engineer_report,d)||(p.item.electrical_engineer_report=d),M(d)}),i(),s(7,Rn,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.electrical_engineer_report),l("ngClass",u(5,ve,t.itemForm.get("electrical_engineer_report").invalid&&(t.itemForm.get("electrical_engineer_report").dirty||t.itemForm.get("electrical_engineer_report").touched))),m(),l("ngIf",t.itemForm.get("electrical_engineer_report").invalid&&(t.itemForm.get("electrical_engineer_report").dirty||t.itemForm.get("electrical_engineer_report").touched))}}function Mn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function An(o,a){if(o&1&&(n(0,"div",11),s(1,Mn,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("ict_engineer_report").errors)==null?null:t.required)}}function qn(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",16),e(5,"ICT Engineer Report:"),i(),n(6,"ckeditor",17),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.ict_engineer_report,d)||(p.item.ict_engineer_report=d),M(d)}),i(),s(7,An,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.ict_engineer_report),l("ngClass",u(5,ve,t.itemForm.get("ict_engineer_report").invalid&&(t.itemForm.get("ict_engineer_report").dirty||t.itemForm.get("ict_engineer_report").touched))),m(),l("ngIf",t.itemForm.get("ict_engineer_report").invalid&&(t.itemForm.get("ict_engineer_report").dirty||t.itemForm.get("ict_engineer_report").touched))}}function kn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function jn(o,a){if(o&1&&(n(0,"div",11),s(1,kn,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("mechanical_engineer_report").errors)==null?null:t.required)}}function On(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",18),e(5,"Mechanical Engineer Report:"),i(),n(6,"ckeditor",19),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.mechanical_engineer_report,d)||(p.item.mechanical_engineer_report=d),M(d)}),i(),s(7,jn,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.mechanical_engineer_report),l("ngClass",u(5,ve,t.itemForm.get("mechanical_engineer_report").invalid&&(t.itemForm.get("mechanical_engineer_report").dirty||t.itemForm.get("mechanical_engineer_report").touched))),m(),l("ngIf",t.itemForm.get("mechanical_engineer_report").invalid&&(t.itemForm.get("mechanical_engineer_report").dirty||t.itemForm.get("mechanical_engineer_report").touched))}}function Bn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Vn(o,a){if(o&1&&(n(0,"div",11),s(1,Bn,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("environment_health_and_safety_report").errors)==null?null:t.required)}}function Ln(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Hn(o,a){if(o&1&&(n(0,"div",11),s(1,Ln,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("professional_sustainability_report").errors)==null?null:t.required)}}function Gn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function zn(o,a){if(o&1&&(n(0,"div",11),s(1,Gn,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("landscaping_report").errors)==null?null:t.required)}}function Un(o,a){if(o&1){let t=L();n(0,"div")(1,"div",5)(2,"div",6)(3,"div",7)(4,"label",20),e(5,"Environment Health and Safety Report:"),i(),n(6,"ckeditor",21),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.environment_health_and_safety_report,d)||(p.item.environment_health_and_safety_report=d),M(d)}),i(),s(7,Vn,2,1,"div",10),i()(),n(8,"div",6)(9,"div",7)(10,"label",22),e(11,"Professional Sustainability Report:"),i(),n(12,"ckeditor",23),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.professional_sustainability_report,d)||(p.item.professional_sustainability_report=d),M(d)}),i(),s(13,Hn,2,1,"div",10),i()(),n(14,"div",6)(15,"div",7)(16,"label",24),e(17,"Landscaping Report:"),i(),n(18,"ckeditor",25),oe("ngModelChange",function(d){w(t);let p=c();return re(p.item.landscaping_report,d)||(p.item.landscaping_report=d),M(d)}),i(),s(19,zn,2,1,"div",10),i()()()()}if(o&2){let t=c();m(6),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.environment_health_and_safety_report),l("ngClass",u(15,ve,t.itemForm.get("environment_health_and_safety_report").invalid&&(t.itemForm.get("environment_health_and_safety_report").dirty||t.itemForm.get("environment_health_and_safety_report").touched))),m(),l("ngIf",t.itemForm.get("environment_health_and_safety_report").invalid&&(t.itemForm.get("environment_health_and_safety_report").dirty||t.itemForm.get("environment_health_and_safety_report").touched)),m(5),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.professional_sustainability_report),l("ngClass",u(17,ve,t.itemForm.get("professional_sustainability_report").invalid&&(t.itemForm.get("professional_sustainability_report").dirty||t.itemForm.get("professional_sustainability_report").touched))),m(),l("ngIf",t.itemForm.get("professional_sustainability_report").invalid&&(t.itemForm.get("professional_sustainability_report").dirty||t.itemForm.get("professional_sustainability_report").touched)),m(5),l("editor",t.mEditor)("config",t.mAppContextService.ckEditorConfig),ne("ngModel",t.item.landscaping_report),l("ngClass",u(19,ve,t.itemForm.get("landscaping_report").invalid&&(t.itemForm.get("landscaping_report").dirty||t.itemForm.get("landscaping_report").touched))),m(),l("ngIf",t.itemForm.get("landscaping_report").invalid&&(t.itemForm.get("landscaping_report").dirty||t.itemForm.get("landscaping_report").touched))}}var Ae=class o{constructor(a,t,r,d,p,xe){this.mToastrService=a;this.mDetailedDesignService=t;this.mAppContextService=r;this.router=d;this.fb=p;this.route=xe;this.mProgress=g(!1);this.item={};this.mEditor=Z;this.itemForm=this.fb.group({architect_report:["",f.nullValidator],structural_engineer_report:["",f.nullValidator],electrical_engineer_report:["",f.nullValidator],ict_engineer_report:["",f.nullValidator],mechanical_engineer_report:["",f.nullValidator],environment_health_and_safety_report:["",f.nullValidator],professional_sustainability_report:["",f.nullValidator],landscaping_report:["",f.nullValidator]})}ngOnInit(){this.getItem()}getItem(){this.id=this.route.snapshot.paramMap.get("id"),this.mProgress=g(!0),this.mDetailedDesignService.getOneItem(this.id).subscribe({next:a=>{a&&(this.item=a,this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onSubmit(a){let t={id:this.id,architect_report:a.architect_report,structural_engineer_report:a.structural_engineer_report,electrical_engineer_report:a.electrical_engineer_report,ict_engineer_report:a.ict_engineer_report,mechanical_engineer_report:a.mechanical_engineer_report,environment_health_and_safety_report:a.environment_health_and_safety_report,professional_sustainability_report:a.professional_sustainability_report,landscaping_report:a.landscaping_report};this.mProgress=g(!0),this.mDetailedDesignService.professionalRecommendationsDetailedPlanItem(t).subscribe({next:r=>{this.mToastrService.success(r.message),this.router.navigateByUrl("/detailed-designs"),this.mProgress=g(!1)},error:r=>{r.error.message&&this.mToastrService.error(r.error.message),this.mProgress=g(!1)}})}static{this.\u0275fac=function(t){return new(t||o)(_(D),_(P),_(b),_(H),_(G),_(q))}}static{this.\u0275cmp=E({type:o,selectors:[["app-professional-recommendation"]],standalone:!1,decls:14,vars:21,consts:[[4,"ngIf"],[3,"ngSubmit","formGroup"],[1,"mt-3","text-right"],["routerLink","/detailed-designs","cButton","","color","danger",1,"me-2"],["type","submit","cButton","","color","success",3,"disabled"],[1,"row"],[1,"col-md-12"],[1,"form-group","mb-3"],["for","architect_report",1,"col-form-label","required"],["formControlName","architect_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["class","invalid-feedback","role","alert",4,"ngIf"],["role","alert",1,"invalid-feedback"],["for","structural_engineer_report",1,"col-form-label","required"],["formControlName","structural_engineer_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","electrical_engineer_report",1,"col-form-label","required"],["formControlName","electrical_engineer_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","ict_engineer_report",1,"col-form-label","required"],["formControlName","ict_engineer_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","mechanical_engineer_report",1,"col-form-label","required"],["formControlName","mechanical_engineer_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","environment_health_and_safety_report",1,"col-form-label","required"],["formControlName","environment_health_and_safety_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","professional_sustainability_report",1,"col-form-label","required"],["formControlName","professional_sustainability_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"],["for","landscaping_report",1,"col-form-label","required"],["formControlName","landscaping_report","type","text",1,"form-control1",3,"ngModelChange","editor","config","ngModel","ngClass"]],template:function(t,r){t&1&&(s(0,bn,1,0,"app-progress",0),n(1,"div")(2,"form",1),x("ngSubmit",function(){return r.onSubmit(r.itemForm.value)}),s(3,Dn,8,7,"div",0)(4,Tn,8,7,"div",0)(5,wn,8,7,"div",0)(6,qn,8,7,"div",0)(7,On,8,7,"div",0)(8,Un,20,21,"div",0),n(9,"div",2)(10,"button",3),e(11,"Cancel"),i(),n(12,"button",4),e(13,"Submit"),i()()()()),t&2&&(l("ngIf",r.mProgress()),m(2),l("formGroup",r.itemForm),m(),l("ngIf",r.mAppContextService.hasRoles(S(9,ye))||r.mAppContextService.hasRoles(S(10,vn))),m(),l("ngIf",r.mAppContextService.hasRoles(S(11,ye))||r.mAppContextService.hasRoles(S(12,xn))),m(),l("ngIf",r.mAppContextService.hasRoles(S(13,ye))||r.mAppContextService.hasRoles(S(14,hn))),m(),l("ngIf",r.mAppContextService.hasRoles(S(15,ye))||r.mAppContextService.hasRoles(S(16,Sn))),m(),l("ngIf",r.mAppContextService.hasRoles(S(17,ye))||r.mAppContextService.hasRoles(S(18,yn))),m(),l("ngIf",r.mAppContextService.hasRoles(S(19,ye))||r.mAppContextService.hasRoles(S(20,Cn))),m(4),l("disabled",r.itemForm.invalid))},dependencies:[A,F,N,I,R,O,k,j,V,B,te],encapsulation:2})}};var Nt=o=>({"is-invalid":o});function $n(o,a){o&1&&v(0,"app-progress")}function Kn(o,a){if(o&1&&(n(0,"option",26),e(1),i()),o&2){let t=a.$implicit;l("value",h(t.id)),m(),C(t.alias)}}function Yn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Jn(o,a){if(o&1&&(n(0,"div",27),s(1,Yn,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("detailed_plan_status_id"))==null||t.errors==null?null:t.errors.required)}}function Qn(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function Xn(o,a){if(o&1&&(n(0,"div",27),s(1,Qn,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("remarks").errors)==null?null:t.required)}}var qe=class o{constructor(a,t,r,d,p,xe){this.mToastrService=a;this.mDetailedDesignService=t;this.mAppContextService=r;this.router=d;this.fb=p;this.route=xe;this.mProgress=g(!1);this.item={};this.mEditor=Z;this.itemForm=this.fb.group({detailed_plan_status_id:["",f.required],remarks:["",f.nullValidator]})}ngOnInit(){this.getItem()}getItem(){this.id=this.route.snapshot.paramMap.get("id"),this.mProgress=g(!0),this.mDetailedDesignService.getOneItem(this.id).subscribe({next:a=>{a&&(this.item=a,this.getNextPreviousDetailedPlanStatus(),this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onSubmit(a){let t={id:this.id,detailed_plan_status_id:a.detailed_plan_status_id,remarks:a.remarks};this.mProgress=g(!0),this.mDetailedDesignService.detailedDesignReportRecommendationsDetailedPlanItem(t).subscribe({next:r=>{this.mToastrService.success(r.message),this.router.navigateByUrl("/detailed-designs"),this.mProgress=g(!1)},error:r=>{r.error.message&&this.mToastrService.error(r.error.message),this.mProgress=g(!1)}})}getNextPreviousDetailedPlanStatus(){this.mProgress=g(!0),this.mDetailedDesignService.nextPreviousStatusDetailedPlanItem(this.item.detailed_plan_status_id).subscribe({next:a=>{a&&(this.mNextPreviousStatuses=a,this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}static{this.\u0275fac=function(t){return new(t||o)(_(D),_(P),_(b),_(H),_(G),_(q))}}static{this.\u0275cmp=E({type:o,selectors:[["app-design-report"]],standalone:!1,decls:72,vars:21,consts:[[4,"ngIf"],[1,"border","p-2","mb-3"],[1,"float-none","w-auto"],[1,"text-bolder","text-muted"],[1,"row"],[1,"col-md-12"],[1,"mb-3"],["for","architect_report"],[1,"text-muted"],["for","electrical_engineer_report"],["for","ict_engineer_report"],["for","mechanical_engineer_report"],["for","environment_health_and_safety_report"],["for","professional_sustainability_report"],[3,"ngSubmit","formGroup"],[1,"form-group","mb-3"],["for","detailed_plan_status_id",1,"col-form-label","required"],["formControlName","detailed_plan_status_id","type","text",1,"form-control",3,"ngClass"],["value","","disabled","true","selected","true"],[3,"value",4,"ngFor","ngForOf"],["class","invalid-feedback","role","alert",4,"ngIf"],["for","remarks",1,"col-form-label","required1"],["formControlName","remarks","type","text",1,"form-control1",3,"editor","config","ngClass"],[1,"mt-3","text-right"],["routerLink","/detailed-designs","cButton","","color","danger",1,"me-2"],["type","submit","cButton","","color","success",3,"disabled"],[3,"value"],["role","alert",1,"invalid-feedback"]],template:function(t,r){if(t&1&&(s(0,$n,1,0,"app-progress",0),n(1,"div")(2,"fieldset",1)(3,"legend",2)(4,"h6",3),e(5,"PROFEFESSIONAL RECOMMENDATIONS"),i()(),n(6,"div",4)(7,"div",5)(8,"div",6)(9,"label",7),e(10,"Architect Report:"),i(),n(11,"div",8),e(12),i()()(),n(13,"div",5)(14,"div",6)(15,"label",9),e(16,"Electrical Engineer Report:"),i(),n(17,"div",8),e(18),i()()(),n(19,"div",5)(20,"div",6)(21,"label",9),e(22,"Structural Engineer Report:"),i(),n(23,"div",8),e(24),i()()(),n(25,"div",5)(26,"div",6)(27,"label",10),e(28,"ICT Engineer Report:"),i(),n(29,"div",8),e(30),i()()(),n(31,"div",5)(32,"div",6)(33,"label",11),e(34,"Mechanical Engineer Report:"),i(),n(35,"div",8),e(36),i()()(),n(37,"div",5)(38,"div",6)(39,"label",12),e(40,"Environment Health and Safety Report:"),i(),n(41,"div",8),e(42),i()()(),n(43,"div",5)(44,"div",6)(45,"label",13),e(46,"Professional Sustainability Report:"),i(),n(47,"div",8),e(48),i()()()()()(),n(49,"div")(50,"form",14),x("ngSubmit",function(){return r.onSubmit(r.itemForm.value)}),n(51,"div",4)(52,"div",5)(53,"div",15)(54,"label",16),e(55,"Status:"),i(),n(56,"select",17)(57,"option",18),e(58,"--- Select status ---"),i(),s(59,Kn,2,3,"option",19),i(),s(60,Jn,2,1,"div",20),i()(),n(61,"div",5)(62,"div",15)(63,"label",21),e(64,"Additional Remarks:"),i(),v(65,"ckeditor",22),s(66,Xn,2,1,"div",20),i()()(),n(67,"div",23)(68,"button",24),e(69,"Cancel"),i(),n(70,"button",25),e(71,"Submit"),i()()()()),t&2){let d,p;l("ngIf",r.mProgress()),m(12),C(r.item.architect_report),m(6),C(r.item.electrical_engineer_report),m(6),C(r.item.structural_engineer_report),m(6),C(r.item.ict_engineer_report),m(6),C(r.item.mechanical_engineer_report),m(6),C(r.item.environment_health_and_safety_report),m(6),C(r.item.professional_sustainability_report),m(2),l("formGroup",r.itemForm),m(6),l("ngClass",u(17,Nt,((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.invalid)&&(((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.dirty)||((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.touched)))),m(3),l("ngForOf",r.mNextPreviousStatuses),m(),l("ngIf",((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.invalid)&&(((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.dirty)||((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.touched))),m(5),l("editor",r.mEditor)("config",r.mAppContextService.ckEditorConfig)("ngClass",u(19,Nt,r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched))),m(),l("ngIf",r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched)),m(4),l("disabled",r.itemForm.invalid)}},dependencies:[A,Y,F,N,I,R,O,ue,fe,ge,k,j,V,B,te],encapsulation:2})}};var Ge=o=>({"is-invalid":o});function er(o,a){o&1&&v(0,"app-progress")}function tr(o,a){if(o&1&&(n(0,"option",16),e(1),i()),o&2){let t=a.$implicit;l("value",h(t.id)),m(),C(t.alias)}}function ir(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function nr(o,a){if(o&1&&(n(0,"div",17),s(1,ir,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("detailed_plan_status_id"))==null||t.errors==null?null:t.errors.required)}}function rr(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function or(o,a){if(o&1&&(n(0,"div",17),s(1,rr,2,0,"div",0),i()),o&2){let t,r=c(2);m(),l("ngIf",(t=r.itemForm.get("letter_of_no_objection").errors)==null?null:t.required)}}function ar(o,a){if(o&1){let t=L();n(0,"div",3)(1,"div",4)(2,"label",18),e(3,"Letter of No Objection:"),i(),n(4,"input",19),x("change",function(d){w(t);let p=c();return M(p.onLetterOfNoObjection(d))}),i(),s(5,or,2,1,"div",9),i()()}if(o&2){let t=c();m(4),l("ngClass",u(2,Ge,t.itemForm.get("letter_of_no_objection").invalid&&(t.itemForm.get("letter_of_no_objection").dirty||t.itemForm.get("letter_of_no_objection").touched))),m(),l("ngIf",t.itemForm.get("letter_of_no_objection").invalid&&(t.itemForm.get("letter_of_no_objection").dirty||t.itemForm.get("letter_of_no_objection").touched))}}function mr(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function lr(o,a){if(o&1&&(n(0,"div",17),s(1,mr,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("remarks").errors)==null?null:t.required)}}var ke=class o{constructor(a,t,r,d,p,xe){this.mToastrService=a;this.mDetailedDesignService=t;this.mAppContextService=r;this.router=d;this.fb=p;this.route=xe;this.mProgress=g(!1);this.item={};this.mEditor=Z;this.itemForm=this.fb.group({detailed_plan_status_id:["",f.required],letter_of_no_objection:["",f.nullValidator],remarks:["",f.nullValidator]})}ngOnInit(){this.getItem()}getItem(){this.id=this.route.snapshot.paramMap.get("id"),this.mProgress=g(!0),this.mDetailedDesignService.getOneItem(this.id).subscribe({next:a=>{a&&(this.item=a,this.getNextPreviousDetailedPlanStatus(),this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onSubmit(a){let t=new FormData;t.append("detailed_plan_status_id",a.detailed_plan_status_id),this.letter_of_no_objection_file?t.append("letter_of_no_objection",this.letter_of_no_objection_file,this.letter_of_no_objection_file.name):t.append("letter_of_no_objection",""),t.append("remarks",a.remarks),t.append("_method","POST"),this.mProgress.set(!0),this.mDetailedDesignService.committeeStageDetailedPlanItem(this.id,t).subscribe({next:r=>{this.mToastrService.success(r.message),this.router.navigateByUrl("/detailed-designs"),this.mProgress=g(!1)},error:r=>{r.error.message&&this.mToastrService.error(r.error.message),this.mProgress=g(!1)}})}getNextPreviousDetailedPlanStatus(){this.mProgress=g(!0),this.mDetailedDesignService.nextPreviousStatusDetailedPlanItem(this.item.detailed_plan_status_id).subscribe({next:a=>{a&&(this.mNextPreviousStatuses=a,this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onLetterOfNoObjection(a){if(a.target.value){let t=a.target.files[0];this.letter_of_no_objection_file=t}}static{this.\u0275fac=function(t){return new(t||o)(_(D),_(P),_(b),_(H),_(G),_(q))}}static{this.\u0275cmp=E({type:o,selectors:[["app-committee-stage"]],standalone:!1,decls:25,vars:15,consts:[[4,"ngIf"],[3,"ngSubmit","formGroup"],[1,"row"],[1,"col-md-12"],[1,"form-group","mb-3"],["for","detailed_plan_status_id",1,"col-form-label","required"],["formControlName","detailed_plan_status_id","type","text",1,"form-control",3,"ngClass"],["value","","disabled","true","selected","true"],[3,"value",4,"ngFor","ngForOf"],["class","invalid-feedback","role","alert",4,"ngIf"],["class","col-md-12",4,"ngIf"],["for","remarks",1,"col-form-label","required1"],["formControlName","remarks","type","text",1,"form-control1",3,"editor","config","ngClass"],[1,"mt-3","text-right"],["routerLink","/detailed-designs","cButton","","color","danger",1,"me-2"],["type","submit","cButton","","color","success",3,"disabled"],[3,"value"],["role","alert",1,"invalid-feedback"],["for","letter_of_no_objection",1,"col-form-label","required"],["formControlName","letter_of_no_objection","type","file",1,"form-control",3,"change","ngClass"]],template:function(t,r){if(t&1&&(s(0,er,1,0,"app-progress",0),n(1,"div")(2,"form",1),x("ngSubmit",function(){return r.onSubmit(r.itemForm.value)}),n(3,"div",2)(4,"div",3)(5,"div",4)(6,"label",5),e(7,"Status:"),i(),n(8,"select",6)(9,"option",7),e(10,"--- Select status ---"),i(),s(11,tr,2,3,"option",8),i(),s(12,nr,2,1,"div",9),i()(),s(13,ar,6,4,"div",10),n(14,"div",3)(15,"div",4)(16,"label",11),e(17,"Additional Remarks:"),i(),v(18,"ckeditor",12),s(19,lr,2,1,"div",9),i()()(),n(20,"div",13)(21,"button",14),e(22,"Cancel"),i(),n(23,"button",15),e(24,"Submit"),i()()()()),t&2){let d,p;l("ngIf",r.mProgress()),m(2),l("formGroup",r.itemForm),m(6),l("ngClass",u(11,Ge,((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.invalid)&&(((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.dirty)||((d=r.itemForm.get("detailed_plan_status_id"))==null?null:d.touched)))),m(3),l("ngForOf",r.mNextPreviousStatuses),m(),l("ngIf",((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.invalid)&&(((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.dirty)||((p=r.itemForm.get("detailed_plan_status_id"))==null?null:p.touched))),m(),l("ngIf",r.itemForm.get("detailed_plan_status_id").value==9),m(5),l("editor",r.mEditor)("config",r.mAppContextService.ckEditorConfig)("ngClass",u(13,Ge,r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched))),m(),l("ngIf",r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched)),m(4),l("disabled",r.itemForm.invalid)}},dependencies:[A,Y,F,N,I,R,O,ue,fe,ee,ge,k,j,V,B,te],encapsulation:2})}};var ze=o=>({"is-invalid":o});function dr(o,a){o&1&&v(0,"app-progress")}function pr(o,a){if(o&1&&(n(0,"span")(1,"a",15),e(2,"File"),i()()),o&2){let t=c();m(),l("href",h(t.item.notice_of_approval_url),y)}}function cr(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function _r(o,a){if(o&1&&(n(0,"div",16),s(1,cr,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("notice_of_approval").errors)==null?null:t.required)}}function gr(o,a){if(o&1&&(n(0,"span")(1,"a",15),e(2,"File"),i()()),o&2){let t=c();m(),l("href",h(t.item.construction_permit_url),y)}}function ur(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function fr(o,a){if(o&1&&(n(0,"div",16),s(1,ur,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("construction_permit").errors)==null?null:t.required)}}function vr(o,a){o&1&&(n(0,"div"),e(1,"This field is required."),i())}function xr(o,a){if(o&1&&(n(0,"div",16),s(1,vr,2,0,"div",0),i()),o&2){let t,r=c();m(),l("ngIf",(t=r.itemForm.get("remarks").errors)==null?null:t.required)}}var je=class o{constructor(a,t,r,d,p,xe){this.mToastrService=a;this.mDetailedDesignService=t;this.router=r;this.fb=d;this.route=p;this.mAppContextService=xe;this.mProgress=g(!1);this.item={};this.mEditor=Z;this.itemForm=this.fb.group({notice_of_approval:["",f.required],construction_permit:["",f.required],remarks:["",f.nullValidator]})}ngOnInit(){this.getItem()}getItem(){this.id=this.route.snapshot.paramMap.get("id"),this.mProgress=g(!0),this.mDetailedDesignService.getOneItem(this.id).subscribe({next:a=>{a&&(this.item=a,this.mProgress=g(!1))},error:a=>{a.error.message&&this.mToastrService.error(a.error.message),this.mProgress=g(!1)}})}onSubmit(a){let t=new FormData;t.append("notice_of_approval",this.notice_of_approval_file||"",this.notice_of_approval_file?.name||""),t.append("construction_permit",this.construction_permit_file||"",this.construction_permit_file?.name||""),t.append("remarks",a.remarks),t.append("_method","POST"),this.mProgress.set(!0),this.mDetailedDesignService.constructionPermitItem(this.id,t).subscribe({next:r=>{this.mToastrService.success(r.message),this.router.navigateByUrl("/detailed-designs"),this.mProgress=g(!1)},error:r=>{r.error.message&&this.mToastrService.error(r.error.message),this.mProgress=g(!1)}})}onConstructionPermitChange(a){if(a.target.value){let t=a.target.files[0];this.construction_permit_file=t}}onNoticeOfApprovalChange(a){if(a.target.value){let t=a.target.files[0];this.notice_of_approval_file=t}}static{this.\u0275fac=function(t){return new(t||o)(_(D),_(P),_(H),_(G),_(q),_(b))}}static{this.\u0275cmp=E({type:o,selectors:[["app-construction-permit"]],standalone:!1,decls:29,vars:19,consts:[[4,"ngIf"],[3,"ngSubmit","formGroup"],[1,"row"],[1,"col-md-12"],[1,"form-group","mb-3"],["for","notice_of_approval",1,"col-form-label","required"],["formControlName","notice_of_approval","type","file",1,"form-control",3,"change","ngClass"],["class","invalid-feedback","role","alert",4,"ngIf"],["for","construction_permit",1,"col-form-label","required"],["formControlName","construction_permit","type","file",1,"form-control",3,"change","ngClass"],["for","remarks",1,"col-form-label","required1"],["formControlName","remarks","type","text",1,"form-control1",3,"editor","config","ngClass"],[1,"mt-3","text-right"],["routerLink","/detailed-designs","cButton","","color","danger",1,"me-2"],["type","submit","cButton","","color","success",3,"disabled"],["target","_blank",1,"btn","btn-link","btn-sm",3,"href"],["role","alert",1,"invalid-feedback"]],template:function(t,r){t&1&&(s(0,dr,1,0,"app-progress",0),n(1,"div")(2,"form",1),x("ngSubmit",function(){return r.onSubmit(r.itemForm.value)}),n(3,"div",2)(4,"div",3)(5,"div",4)(6,"label",5),e(7,"Notice of Approval: "),s(8,pr,3,2,"span",0),i(),n(9,"input",6),x("change",function(p){return r.onNoticeOfApprovalChange(p)}),i(),s(10,_r,2,1,"div",7),i()(),n(11,"div",3)(12,"div",4)(13,"label",8),e(14,"Construction Permit: "),s(15,gr,3,2,"span",0),i(),n(16,"input",9),x("change",function(p){return r.onConstructionPermitChange(p)}),i(),s(17,fr,2,1,"div",7),i()(),n(18,"div",3)(19,"div",4)(20,"label",10),e(21,"Additional Remarks:"),i(),v(22,"ckeditor",11),s(23,xr,2,1,"div",7),i()()(),n(24,"div",12)(25,"button",13),e(26,"Cancel"),i(),n(27,"button",14),e(28,"Submit"),i()()()()),t&2&&(l("ngIf",r.mProgress()),m(2),l("formGroup",r.itemForm),m(6),l("ngIf",r.item.notice_of_approval_url),m(),l("ngClass",u(13,ze,r.itemForm.get("notice_of_approval").invalid&&(r.itemForm.get("notice_of_approval").dirty||r.itemForm.get("notice_of_approval").touched))),m(),l("ngIf",r.itemForm.get("notice_of_approval").invalid&&(r.itemForm.get("notice_of_approval").dirty||r.itemForm.get("notice_of_approval").touched)),m(5),l("ngIf",r.item.construction_permit_url),m(),l("ngClass",u(15,ze,r.itemForm.get("construction_permit").invalid&&(r.itemForm.get("construction_permit").dirty||r.itemForm.get("construction_permit").touched))),m(),l("ngIf",r.itemForm.get("construction_permit").invalid&&(r.itemForm.get("construction_permit").dirty||r.itemForm.get("construction_permit").touched)),m(5),l("editor",r.mEditor)("config",r.mAppContextService.ckEditorConfig)("ngClass",u(17,ze,r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched))),m(),l("ngIf",r.itemForm.get("remarks").invalid&&(r.itemForm.get("remarks").dirty||r.itemForm.get("remarks").touched)),m(4),l("disabled",r.itemForm.invalid))},dependencies:[A,F,N,I,R,O,ee,k,j,V,B,te],encapsulation:2})}};var Ce=()=>[1],Sr=()=>[2],yr=()=>[10,11],Cr=()=>[9,12,13,14,15,16],Ue=()=>[10,11,12,17];function br(o,a){o&1&&v(0,"app-progress")}function Er(o,a){if(o&1&&(n(0,"div",6),e(1,`
              `),n(2,"label",24),e(3,"Company:"),i(),e(4,`
              `),n(5,"div",8),e(6),i(),e(7,`
            `),i()),o&2){let t=c();m(6),C(t.item.investor==null?null:t.item.investor.name)}}function Fr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.indemnity_form_url),y)}}function Dr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.architectural_design_url),y)}}function Ir(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.structural_design_url),y)}}function Pr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.electrical_design_url),y)}}function Tr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.ict_design_url),y)}}function Nr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.mechanical_design_url),y)}}function Rr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.landscaping_design_url),y)}}function wr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.signage_design_url),y)}}function Mr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.other_relevant_documents_url),y)}}function Ar(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.green_certification_registration_url),y)}}function qr(o,a){if(o&1&&(n(0,"div"),e(1,`
                      `),n(2,"a",25),e(3,"File"),i(),e(4,`
                    `),i()),o&2){let t=c();m(2),l("href",h(t.item.nema_project_report_url),y)}}function kr(o,a){o&1&&(n(0,"div"),e(1,`
              `),v(2,"app-create"),e(3,`
  ...
  `),n(3,"c-col",1),e(4,`
    `),n(5,"c-card",2),e(6,`
      `),n(7,"c-card-body"),e(8,`
        ...
        `),n(163,"div",3),e(164,`
          `),n(165,"div",4),e(166,`
            `),e(167,`
            `),s(168,kr,4,0,"div",0),e(169,`
            `),e(170,`
            `),s(171,jr,4,0,"div",0),e(172,`
            `),e(173,`
            `),s(174,Or,4,0,"div",0),e(175,`
            `),e(176,`
            `),s(177,Br,4,0,"div",0),e(178,`
            `),e(179,`
            `),s(180,Vr,4,0,"div",0),e(181,`
            `),e(182,`
            `),s(183,Lr,4,0,"div",0),e(184,`
          `),i(),e(185,`
        `),i(),e(186,`
    ...
    `),i(),e(188,`
  `),i(),e(189,`
`),i()),t&2&&(l("ngIf",r.mProgress()),m(13),l("ngIf",r.item.investor),m(11),C(r.item.project_brief),m(21),l("ngIf",r.item.indemnity_form),m(11),l("ngIf",r.item.architectural_design),m(11),l("ngIf",r.item.structural_design),m(11),l("ngIf",r.item.electrical_design),m(11),l("ngIf",r.item.ict_design),m(11),l("ngIf",r.item.mechanical_design),m(11),l("ngIf",r.item.landscaping_design),m(11),l("ngIf",r.item.signage_design),m(11),l("ngIf",r.item.other_relevant_documents),m(11),l("ngIf",r.item.green_certification_registration),m(11),l("ngIf",r.item.nema_project_report),m(13),l("ngIf",r.item.detailed_plan_status_id==1&&(r.mAppContextService.hasRoles(S(20,Ce))||r.mAppContextService.hasRoles(S(21,Sr)))),m(3),l("ngIf",r.item.detailed_plan_status_id==3&&(r.mAppContextService.hasRoles(S(22,Ce))||r.mAppContextService.hasRoles(S(23,yr)))),m(3),l("ngIf",r.item.detailed_plan_status_id==4&&(r.mAppContextService.hasRoles(S(24,Ce))||r.mAppContextService.hasRoles(S(25,Cr)))),m(3),l("ngIf",r.item.detailed_plan_status_id==5&&(r.mAppContextService.hasRoles(S(26,Ce))||r.mAppContextService.hasRoles(S(27,Ue)))),m(3),l("ngIf",(r.item.detailed_plan_status_id==6||r.item.detailed_plan_status_id==8)&&(r.mAppContextService.hasRoles(S(28,Ce))||r.mAppContextService.hasRoles(S(29,Ue)))),m(3),l("ngIf",r.item.detailed_plan_status_id==9&&(r.mAppContextService.hasRoles(S(30,Ce))||r.mAppContextService.hasRoles(S(31,Ue)))))},dependencies:[F,I,J,z,Q,X,Se,we,Ae,qe,ke,je],encapsulation:2})}};var Hr=[{path:"",redirectTo:"index",pathMatch:"full"},{path:"index",component:Te,data:{title:"Construction Permits / Detailed Designs"}},{path:"create",component:Se,data:{title:"Construction Permits / Detailed Designs / Create"}},{path:"edit/:id",component:Ne,data:{title:"Construction Permits / Detailed Designs / Edit"}},{path:"show/:id",component:Re,data:{title:"Construction Permits / Detailed Designs / Show"}},{path:"process/:id",component:Oe,data:{title:"Construction Permits / Detailed Designs / Process"}}],Be=class o{static{this.\u0275fac=function(t){return new(t||o)}}static{this.\u0275mod=Fe({type:o})}static{this.\u0275inj=Ee({imports:[Ie,He.forChild(Hr),He]})}};var Rt=class o{static{this.\u0275fac=function(t){return new(t||o)}}static{this.\u0275mod=Fe({type:o})}static{this.\u0275inj=Ee({imports:[Ie,Be,St,ot,st,z,_t,gt,ft,rt,ht,ut,bt,nt,at,Pe,mt,Ft]})}};export{Rt as DetailedDesignModule};
